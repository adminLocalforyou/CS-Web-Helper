...
// Fix: Define as React.FC to handle React-specific props like key implicitly
...
// Fix: Use React.FC to properly handle standard React props like 'key' when component is used in a map function
            ...
            content: (
              <Fragment>
                <TwoAppBoxes 
                  ...
                  box1Content={<Fragment><ol className="list-decimal list-inside"><li>{"ไปที่ Application"}</li><li>{"เลือกออเดอร์นั้นๆ"}</li><li>{"กดจุด 3 จุดมุมขวา"}</li><li>{"Cancel Driver"}</li></ol><FallbackLogic /></Fragment>} 
                  box2Title={<AppName name="Local for you App" />} 
                  box2Content={<Fragment><ol className="list-decimal list-inside"><li>{"ไปที่ Application restaurant order-taking app (Local for you)"}</li><li>{"เลือกออเดอร์นั้นๆที่ต้องการ Refund"}</li><li>{"กดจุดสามจุดมุมขวาล่าง"}</li><li>{"กด Cancel order"}</li></ol><p className="mt-2 text-sm text-green-700 font-semibold">{"(วิธีนี้ลูกค้าของทางร้านจะได้รับเงิน Refund)"}</p></Fragment>} 
                />
                <div className="mt-4 p-3 bg-gray-50 border-l-4 border-gray-400 rounded-lg text-xs text-gray-700">
                  <p className="font-bold mb-1 text-gray-800">{"รายละเอียดเพิ่มเติมสำหรับตัวเลือกที่ 2 (กรณีไม่สามารถยกเลิก Driver ได้):"}</p>
                  <p>{"ทางร้านควรปล่อยให้ Driver มาที่ร้านตามปกติ จากนั้นแจ้ง Driver ว่าออเดอร์ถูกยกเลิกไปแล้ว และทำเรื่องขอ Refund ค่าคนขับมาทาง CS ด้วยเหตุผล: \"รอคนขับมารับอาหารที่ร้านนาน ลูกค้ายกเลิกออเดอร์แล้ว ขอ Refund ค่าส่งที่เรียกคนขับมาและคนขับมาข้า\""}</p>
  ...
  'not-received': {
    ...
    options: {
      'wants_food': {
        title: '1. ลูกค้าต้องการอาหารอยู่', options: {
          ...
          'lfy_redispatch': { 
            ...
            content: (
              <TwoAppBoxes 
                box1Title={<Fragment><AppName name="IHD App" /> {"(เรียกคนขับใหม่)"}</Fragment>} 
                ...
                box2Title={<Fragment><AppName name="IHD App" /> {"(ขอ Refund ค่าอาหารที่หายไป)"}</Fragment>} 
                box2Content={<Fragment><ol className="list-decimal list-inside"><li>{"เลือกออเดอร์เดิมที่ต้องการเงินคืน"}</li><li>{"กดจุด 3 จุดมุมขวาบน"}</li><li>{"เลือก "}<strong>{"Request Refund"}</strong></li></ol><p className="mt-2 text-sm text-green-700 font-semibold">{"(วิธีนี้ทางร้านจะได้เงินคืนสำหรับค่าอาหารที่หายไป)"}</p></Fragment>} 
              /> 
            )
          }
        }
      ...
      'customer_cancels': {
        ...
        content: (
          <TwoAppBoxes
            box1Title={<Fragment><AppName name="Local for you App" /> {"(Refund ลูกค้า)"}</Fragment>}
            box1Content={<Fragment><ol className="list-decimal list-inside"><li>{"ไปที่ Application restaurant order-taking app (Local for you)"}</li><li>{"เลือกออเดอร์นั้นๆที่ต้องการ Refund"}</li><li>{"กดจุดสามจุดมุมขวาล่าง"}</li><li>{"กด Cancel order"}</li></ol><p className="mt-2 text-sm text-green-700 font-semibold">{"(วิธีนี้ลูกค้าของทางร้านจะได้รับเงิน Refund)"}</p></Fragment>}
            box2Title={<Fragment><AppName name="IHD App" /> {"(ขอ Refund ค่าอาหารที่เสียหายไป)"}</Fragment>}
            box2Content={<Fragment><ol className="list-decimal list-inside"><li>{"ไปที่ IHD App"}</li><li>{"เลือกออเดอร์นั้นๆ"}</li><li>{"กดจุด 3 จุดมุมขวา"}</li><li>{"เลือก "}<strong>{"Request Refund"}</strong></li></ol><p className="mt-2 text-sm text-green-700 font-semibold">{"(วิธีนี้ทางร้านจะได้เงินคืนสำหรับค่าอาหารที่เสียหายไป)"}</p></Fragment>} 
          />
        )
      },
      'wait_monitor': { 
              ...
              'lfy_redispatch': { 
                ...
                content: (
                  <TwoAppBoxes 
                    ...
                    box2Title={<Fragment><AppName name="IHD App" /> {"(ขอ Refund ค่าอาหารที่ส่งไม่สำเร็จ/หายไป)"}</Fragment>} 
                    box2Content={<Fragment><ol className="list-decimal list-inside"><li>{"ให้ร้านเข้าที่ IHD App"}</li><li>{"เลือกออเดอร์เดิมที่ต้องการเงินคืนจากการส่งไม่สำเร็จ"}</li><li>{"กดจุด 3 จุดมุมขวาบน"}</li><li>{"เลือก "}<strong>{"Request Refund"}</strong></li></ol><p className="mt-2 text-sm text-green-700 font-semibold">{"(วิธีนี้ทางร้านจะได้เงินคืนสำหรับค่าอาหารที่ส่งไม่สำเร็จของออเดอร์ก่อนหน้า)"}</p></Fragment>} 
                  /> 
                )
              }
            }
          ...
          'customer_cancels': { 
            ...
            content: (
              <TwoAppBoxes 
                ...
                box2Title={<Fragment><AppName name="IHD App" /> {"(ขอ Refund ค่าอาหารที่ส่งไม่สำเร็จ/หายไป)"}</Fragment>} 
                box2Content={<Fragment><ol className="list-decimal list-inside"><li>{"ไปที่ IHD App"}</li><li>{"เลือกออเดอร์นั้นๆ"}</li><li>{"กดจุด 3 จุดมุมขวา"}</li><li>{"เลือก "}<strong>{"Request Refund"}</strong></li></ol><p className="mt-2 text-sm text-green-700 font-semibold">{"(วิธีนี้ทางร้านจะได้เงินคืนสำหรับค่าอาหารที่หายไป)"}</p></Fragment>} 
              /> 
            )
          }
        }
